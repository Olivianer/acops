...
namespace OKHeuristicSearchRoomTest
{
	...
	/// </summary>
	public class LloydPuzzleProblem : IHeuristicSearchProblem
    {
        ...
        /// <summary>
        /// Zeigt auf die verwendete Heuristik
        /// </summary>
        /// 
        private IHeuristicValue m_HeuristicValue = new LloydPuzzleHeuristic();
        ...
        public IHeuristicValue HeuristicValue
        {
            get
            {
