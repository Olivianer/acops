...
{
    /// <summary>
    /// Diese Klasse realisiert die Modulo-Operation.
    /// </summary>
    public class Mod : Operation
    {
        ...
        public Mod(IOperation op1, IOperation op2)
        {
        ...
        /// <summary>
        /// Es wird die Modulooperation durchgeführt.
        /// </summary>
        /// <param name="result">Liefert das Ergebnis der Modulooperation</param>
