...
{
    /// <summary>
    /// Diese Klasse repräsentiert die Vergleichsoperation.
    /// </summary>
    public class Equal : Operation
    {
        ...
        public Equal(IOperation op1, IOperation op2)
        {
        ...
        /// <summary>
        /// Gibt das Ergebnis des Vergleichs zurück, also entweder 0.0 oder 1.0.
        /// </summary>
        /// <param name="result">Liefert 1.0 bei Gleichheit, sonst 0.0.</param>
