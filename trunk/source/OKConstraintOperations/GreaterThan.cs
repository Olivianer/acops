...
{
    /// <summary>
    /// Diese Klasse repräsentiert die GrößerAlsOperation.
    /// </summary>
    public class GreaterThan : Operation
    {
        ...
        public GreaterThan(IOperation op1, IOperation op2)
        {
        ...
        /// </summary>
        /// <param name="result">Liefert 1.0, wenn der erste Operator größer als der zweite ist, sonst 0.0.</param>
