...
{
    /// <summary>
    /// Diese Klasse repräsentiert die Ungleichsoperation.
    /// </summary>
    public class UnEqual : Operation
    {
        ...
        public UnEqual(IOperation op1, IOperation op2)
        {
        ...
        /// <summary>
        /// Gibt das Ergebnis der UngleichOperation zurück, also entweder 0.0 oder 1.0.
        /// </summary>
        /// <param name="result">Liefert 1.0 bei Ungleichheit, sonst 0.0.</param>
