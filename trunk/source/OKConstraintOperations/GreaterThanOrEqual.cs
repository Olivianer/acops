...
{
    /// <summary>
    /// Diese Klasse repräsentiert die GrößerGleichOperation.
    /// </summary>
    public class GreaterThanOrEqual : Operation
    {
        ...
        public GreaterThanOrEqual(IOperation op1, IOperation op2)
        {
        ...
        /// <summary>
        /// Liefert im Parameter zurück, ob der erste Operator größer als der zweite ist.
        /// </summary>
        /// <param name="result">Liefert 1.0, wenn der erste Operator größer oder gleich dem zweiten ist, sonst 0.0.</param>
